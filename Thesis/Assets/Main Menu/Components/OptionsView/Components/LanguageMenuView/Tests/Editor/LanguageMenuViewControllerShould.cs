...
namespace SJ.Tests
{
    public class LanguageMenuViewControllerShould
    {
        ...
        public void SetUp()
        {
            view = Substitute.For<ILanguageMenuView>();
        ...
        {
            controller = new LanguageMenuViewController(view, translatorService, gameSettingsRepository);
        }
