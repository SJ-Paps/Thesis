...
namespace SJ.Menu
{
    public class GeneralGameInputSettingsScreenViewController
    {
        ...
        private IGeneralGameInputSettingsScreenView view;
        ...
        public GeneralGameInputSettingsScreenViewController(IGeneralGameInputSettingsScreenView view, IGameInputSettingsRepository gameInputSettingsRepository,
        ...
        private void Initialize()
        {
            ...
            view.OnGoToJoystickMapClicked += view.FocusKeyboardMappingScreen;
