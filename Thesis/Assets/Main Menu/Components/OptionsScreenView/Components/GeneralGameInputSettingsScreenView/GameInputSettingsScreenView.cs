...
namespace SJ.Menu
{
    public class GameInputSettingsScreenView : SJMonoBehaviour, IGameInputSettingsScreenView
    {
        [SerializeField]
        ...
        public event UnityAction OnGoToJoystickMappingClicked
        {
        ...
        public void FocusJoystickMappingScreen()
        {
